...
class Ion_auth_model extends CI_Model
{
	...
	public function register($username, $password, $email, $additional_data = array(), $groups = array())
	{
        ...
        if(!isset($additional_data['group_id']) || !is_numeric($additional_data['group_id'])){
            $additional_data['group_id'] = $default_group->id;
        }
	...
	public function users($groups = NULL)
	{
        ...
        $this->db->select($this->tables['groups'].".name group_name, ".$this->tables['groups'].".description group_description");
        $this->db->join($this->tables['groups'], $this->tables['groups'].".id = ".$this->tables['users'].".group_id", "left");
